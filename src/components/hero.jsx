    ...
    >
      ...
      <div className="container mx-auto relative flex-1">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="md:w-1/2 mb-4 md:mb-0 md:mt-[-80px] md:ml-16 text-center md:text-left">
          ...
          <div className="md:w-1/2 flex justify-center md:justify-start mb-4 md:mb-0 md:ml-4 md:mt-[-80px]"> {/* Menggeser gambar ke kiri di layar desktop */}
