      ...
      <div className="container mx-auto flex flex-wrap justify-between">
        <div className="w-full md:w-1/4 md:ml-8 mb-8 md:mb-0">
          ...
          <div className="flex mt-4">
            ...
            <a href="#" className="mr-4"><FontAwesomeIcon icon={faWhatsapp} className="text-gray-300 hover:text-white" /></a>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <ul className="list-none mt-4">
            ...
            <li className="mb-2 flex items-center">
              ...
              <a className="text-gray-300 hover:text-white" href="#">+62 812-3456-789</a>
            </li>
          </ul>
        </div>
      </div>
